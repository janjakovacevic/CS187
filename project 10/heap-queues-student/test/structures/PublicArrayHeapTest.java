...
public class PublicArrayHeapTest {
  ...
  public void testBubbleUpDown(){
	  ...
	  assertEquals("The second element in the array should be 1.", new Integer(1), view.get(1).getValue());
	  arrayHeap.remove();
	  assertEquals("Peek value should be 1.", new Integer(1), arrayHeap.peek());
	  assertEquals("The only element in the array should be 1.", new Integer(1), view.get(0).getValue());
	  arrayHeap.add("...", 3);
	  assertEquals("Peek value should be 3.", new Integer(3), arrayHeap.peek());
	  assertEquals("The second element in the array should be 1.", new Integer(1), view.get(1).getValue());
	  arrayHeap.add("....", 4);
	  ...
	  arrayHeap.add("....", 4);
	  arrayHeap.add("..", 2);
	  assertEquals("Peek value should be 6.", new Integer(6), arrayHeap.peek());
	  assertEquals("The last element in the array should be 2.", new Integer(2), view.get(5).getValue());
